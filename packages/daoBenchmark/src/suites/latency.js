...
function daoCalculatePercentile(values, percentile) {
    if (values.length === 0)
        return 0;
...
async function daoSimulateFeedbackLoop() {
...
export async function daoMeasureFeedbackLatency(iterations = 1000) {
