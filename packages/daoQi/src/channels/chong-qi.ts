 ...
 * [文字说明] 帛书（马王堆乙本）作"中气"（zhōng qì，居间调和之气）；
 *           通行本（王弼）作"冲气"（chōng qì，激荡冲突之气）。
 *           本类命名保留"Chong"以维持 API 兼容，但哲学内涵对应帛书"中气"——
 *           中气者，阴阳在平衡、居间状态下自然交融而成和者也；
 *           非阴阳相搏激荡，而是守中调柔，不争而和，体现道家"清静无为"底色。
 */
